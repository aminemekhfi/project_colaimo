...
<body>
	...
	<div class="bg-img1 size1 flex-w flex-c-m p-t-55 p-b-55 p-l-15 p-r-15" style="background-image: url('images/bg01.jpg');">
        <div class="wsize1 bor1 txt-center bg1 p-t-70 p-b-100 p-l-15 p-r-15 respon1 ">
            ...
            <div class="wsize2 flex-w flex-c hsize1 cd20">
                <iframe width="500" height="400" frameborder="0" src="https://www.bing.com/maps/embed?h=400&w=500&cp=34.69554378094986~-1.8851423263549805&lvl=16&typ=d&sty=r&src=SHELL&FORM=MBEDV8" scrolling="no">
                </iframe>
                <div style="white-space: nowrap; text-align: center; width: 500px; padding: 6px 0;">
                   <a id="largeMapLink" target="_blank" href="https://www.bing.com/maps?cp=34.69554378094986~-1.8851423263549805&amp;sty=r&amp;lvl=16&amp;FORM=MBEDLD">Afficher une carte plus grande</a> &nbsp; | &nbsp;
                   <a id="dirMapLink" target="_blank" href="https://www.bing.com/maps/directions?cp=34.69554378094986~-1.8851423263549805&amp;sty=r&amp;lvl=16&amp;rtp=~pos.34.69554378094986_-1.8851423263549805____&amp;FORM=MBEDLD">Calculer l’itinéraire</a>
               </div>
           </div>

			<p class="s1-txt4 txt-center p-t-100">
				Copyright ©  <span>2023 —</span> COLAIMO 
			</p>
